		...
		<nav>
			<ul>
				...
				<li class="<?php if($menu == 'biller'){echo 'active';}else{echo '';}?>">
					...
					<ul>
						<?php if(in_array('biller/listing',$perm)){ ?>
                        ...
                        <?php if(in_array('biller/add_biller',$perm) || in_array('biller/edit_biller',$perm)){ ?>
                        ...
                        <?php if(in_array('biller',$perm) || in_array('biller/pending_biller',$perm) || in_array('biller/approved_biller',$perm) || in_array('biller/declined_biller',$perm)){ ?>
						<li class="<?php if($sub_menu == 'biller_approval'){echo 'active';}else{echo '';}?>">
							<a href="#" title="Biller Setup Approval"> <span class="menu-item-parent">Biller Setup Approval</span></a>
                               <ul>
                                    <?php if(in_array('biller/pending_biller',$perm)){ ?>
                                    ...
                                    <?php if(in_array('biller/approved_biller',$perm)){ ?>
                                    ...
                                    <?php if(in_array('biller/declined_biller',$perm)){ ?>								
						...
						<?php if(in_array('biller_administration',$perm)){ ?>
							...
							<a href="#" title="Biller Configuration"> <span class="menu-item-parent">Biller Configuration</span></a>
                             <ul>
                                  <li class="<?php if($sub_sub_menu == 'biller_administration'){echo 'active';}else{echo '';}?>">
                                      <a href="<?php echo site_url('biller_administration');?>" title="Biller Administration"> <span class="menu-item-parent">Biller Administration</span></a>
                                  </li>
                ...
                <?php if(in_array('ercas_message',$perm)){ ?>
                <li>
                ...
                <?php if(in_array('usergroup_privileges',$perm) || in_array('registration',$perm) || in_array('users',$perm)){ ?>                <li class="<?php if($menu == 'user_privileges'){echo 'active';}else{echo '';}?>">
                    <a href="#"><i class="fa fa-lg fa-fw fa-users"></i> <span class="menu-item-parent">User Administration</span></a>
                    <ul>
                        <?php if(in_array('usergroup_privileges',$perm)){ ?>
                        ...
                        <?php if(in_array('registration',$perm)){ ?>
                ...
                <?php if(in_array('general_setting',$perm)){ ?>
