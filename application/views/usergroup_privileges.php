										...
										<div id="collapseTwo-1" class="panel-collapse collapse">
											<fieldset>
												<section>
													...
													<input type="checkbox" name="permissions[]" value="biller/listing">
													<i></i>List of Billers</label>
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller/add_biller">
													<i></i>Create New Biller</label>
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller/edit_biller">
													<i></i>Edit Biller</label>
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller">
													<i></i>Approve New Biller</label>
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller/pending_biller">
													<i></i>Pending Biller Request</label>
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller/approved_biller">
													<i></i>Approved Billers</label>
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller/declined_biller">
													...
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller/biller_configuration" >
													<i></i>Biller Configuration</label>
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller/biller_configuration_change">
													<i></i>Biller Configuration Change</label>
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller/alter_table">
