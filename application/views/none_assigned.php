	...
	<div id="content">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark"><!-- PAGE HEADER --><i class="fa-fw fa fa-edit"></i> Support Message <span> > Unassigned Tickets</span></h1>
			</div>
			<!-- end col -->
		</div>
		<!-- end row -->
					...
					<table class="table table-striped table-forum">
						...
						<tbody>							
							...
							<tr>
								...
								<?php 
								if($tlist->ticket_created_by == 0)
								{
									echo 'Biller';
								}
								else
								{
									$creatordt = $this->user_model->user_detail($tlist->ticket_created_by);
